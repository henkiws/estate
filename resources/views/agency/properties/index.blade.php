                        ...
                        <div class="flex items-center justify-between gap-3 lg:gap-4 text-xs text-gray-500 mb-4 pb-4 border-t border-gray-200">
                            <div class="flex items-center gap-3 lg:gap-4">
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="hidden sm:inline">{{ $property->applications->count() }} apps</span>
                                ...
                                <div class="flex items-center gap-1">
                                    ...
                                    <span class="hidden sm:inline">{{ optional($property->inspectionBookings)->count() ?? 0 }} bookings</span>
                                    <span class="sm:hidden">{{ optional($property->inspectionBookings)->count() ?? 0 }}</span>
                                </div>
                            </div>
