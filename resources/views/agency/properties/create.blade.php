...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="mb-8 flex items-center justify-between">
        <div>
            <h1 class="text-3xl font-bold text-plyform-dark">Add New Property</h1>
    ...
    <form id="propertyForm" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div class="md:col-span-2">
                        ...
                        <div class="flex items-center gap-4 p-4 bg-plyform-mint/10 border-2 border-plyform-mint rounded-xl">
                            ...
                            <div>
                                <div class="text-2xl font-bold text-plyform-dark" id="bondDisplay">$0</div>
        ...
        <div class="flex items-center gap-4">
            ...
            <a href="{{ route('agency.properties.index') }}" class="px-6 py-3 bg-gray-100 text-gray-700 rounded-xl hover:bg-gray-200 transition font-medium">
                Cancel
            </a>
        </div>
    </form>
...
<div id="successModal" class="hidden fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
    <div class="bg-white rounded-2xl shadow-2xl max-w-2xl w-full p-8 transform transition-all scale-95 border-4 border-plyform-mint" id="modalContent">
        ...
        <!-- Title -->
        <h2 class="text-3xl font-bold text-center text-plyform-dark mb-2">🎉 Congratulations!</h2>
        ...
        <div class="mt-4 text-center">
            <a href="{{ route('agency.properties.index') }}" class="text-sm text-plyform-purple hover:text-plyform-dark font-medium inline-flex items-center gap-1">
                <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 19l-7-7m0 0l7-7m-7 7h18"></path>
                </svg>
