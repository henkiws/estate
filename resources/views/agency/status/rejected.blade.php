...
<head>
    ...
    <title>Application Rejected - Sorted Services</title>
            ...
            <div class="bg-white rounded-2xl shadow-xl p-8 md:p-12 animate-fadeIn">
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-xl p-6 mb-8">
                    <div class="flex">
                        ...
                        <div class="ml-4">
                            <h3 class="text-sm font-semibold text-blue-900 mb-2">What Can You Do?</h3>
                ...
                <div class="bg-gray-50 rounded-xl p-6 mb-8">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3">Common Rejection Reasons</h3>
                ...
                <div class="flex flex-col sm:flex-row gap-4">
                    <a href="mailto:support@sorted.com?subject=Regarding%20Rejected%20Application%20-%20{{ $agency->agency_name }}" 
                       class="flex-1 inline-flex items-center justify-center px-6 py-3 bg-blue-600 text-white font-semibold rounded-lg hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl">
                    ...
                    <form method="POST" action="{{ route('agency.onboarding.new-application') }}" class="flex-1">
                        @csrf
                        <button type="submit" 
                                class="lex-1 inline-flex items-center justify-center px-6 py-3 bg-gray-100 text-gray-700 font-semibold rounded-lg hover:bg-gray-200 transition-colors">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <form method="POST" action="{{ route('logout') }}" class="flex-1">
                        @csrf
                        <button type="submit" 
                                class="w-full inline-flex items-center justify-center px-6 py-3 bg-white border border-gray-300 text-gray-700 font-semibold rounded-lg hover:bg-gray-50 transition-colors">
                            <svg class="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
