...
<body class="bg-gradient-to-br from-gray-50 via-white to-blue-50">
    <div class="min-h-screen py-8 px-4" x-data="{ isYearly: false }">
        <div class="max-w-7xl mx-auto">
            ...
            <!-- Error Messages -->
            @if(session('error'))
            <div class="bg-red-50 border-l-4 border-red-500 rounded-xl p-6 mb-8 shadow-lg animate-fadeIn">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-xl font-bold text-red-900 mb-1">⚠️ Error</h3>
            ...
            <!-- Warning Messages -->
            @if(session('warning'))
            <div class="bg-yellow-50 border-l-4 border-yellow-500 rounded-xl p-6 mb-8 shadow-lg animate-fadeIn">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-xl font-bold text-yellow-900 mb-1">⚠️ Warning</h3>
            ...
            <!-- Success Messages -->
            @if(session('success'))
            <div class="bg-green-50 border-l-4 border-green-500 rounded-xl p-6 mb-8 shadow-lg animate-fadeIn">
                <div class="flex items-start">
                    <div class="flex-shrink-0">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-xl font-bold text-green-900 mb-1">✅ Success</h3>
            ...
            <div class="bg-red-50 border-l-4 border-red-500 rounded-xl p-6 mb-8 shadow-lg animate-fadeIn">
                <div class="flex items-start">
                    ...
                    <div class="ml-4 flex-1">
                        <h3 class="text-xl font-bold text-red-900 mb-2">⚠️ Validation Errors</h3>
            ...
            @else
            <div class="bg-red-50 border-l-4 border-red-500 rounded-xl p-8 mb-8 text-center">
                <svg class="w-16 h-16 text-red-400 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path>
                </svg>
                <h3 class="text-xl font-bold text-red-900 mb-2">No Subscription Plans Available</h3>
                <p class="text-red-700 mb-4">Please run the subscription plans seeder:</p>
                <code class="bg-red-100 text-red-800 px-4 py-2 rounded text-sm">php artisan db:seed --class=SubscriptionPlansSeeder</code>
            </div>
            @endif
