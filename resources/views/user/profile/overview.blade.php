...
<div class="py-8">
    <div class="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="space-y-4">
            ...
            @include('user.profile.cards.about-you-card', ['mode' => 'profile'])
            
            <!-- Section 1: Personal Details -->
            @include('user.profile.cards.personal-details-card', ['mode' => 'profile'])
            
            <!-- Section 2: Introduction -->
            @include('user.profile.cards.introduction-card', ['mode' => 'profile'])
            
            <!-- Section 3: Current Income -->
            @include('user.profile.cards.income-card', ['mode' => 'profile'])
            
            <!-- Section 4: Employment -->
            @include('user.profile.cards.employment-card', ['mode' => 'profile'])
            
            <!-- Section 5: Pets -->
            @include('user.profile.cards.pets-card', ['mode' => 'profile'])
            
            <!-- Section 6: Vehicles -->
            @include('user.profile.cards.vehicles-card', ['mode' => 'profile'])
            
            <!-- Section 7: Address History -->
            @include('user.profile.cards.address-history-card', ['mode' => 'profile'])
            
            {{-- <!-- Section 8: References -->
            @include('user.profile.cards.references-card') --}}
            
            <!-- Section 9: Identification -->
            @include('user.profile.cards.identification-card', ['mode' => 'profile'])
