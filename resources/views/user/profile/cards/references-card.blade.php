    ...
    <div class="p-6">
        <div class="flex items-start justify-between">
            ...
            <div class="flex items-start gap-4 ml-4">
                ...
                <div class="flex items-center justify-center w-14 h-14 rounded-full border-4 {{ $user->references && $user->references->count() >= 2 ? 'border-plyform-yellow' : 'border-gray-300' }} bg-white">
                    <span class="text-sm font-bold {{ $user->references && $user->references->count() >= 2 ? 'text-plyform-yellow' : 'text-gray-400' }}" id="references-percentage">
                        @if($user->references && $user->references->count() >= 2)
                            100%
                        @else
                            0%
