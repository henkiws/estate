...
<div class="py-8">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-gray-600">Submit a support request and our team will respond as soon as possible</p>
        </div>
                ...
                <div class="p-6 space-y-6">
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            value="{{ old('subject') }}"
                            required
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('subject') border-red-500 @enderror"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                name="category" 
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('category') border-red-500 @enderror"
                            >
                                <option value="">Select a category</option>
                                <option value="profile" {{ old('category') === 'profile' ? 'selected' : '' }}>Profile</option>
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                name="priority" 
                                required
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('priority') border-red-500 @enderror"
                            >
                    ...
                    <div>
                        ...
                        <input 
                            ...
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-teal-500 focus:border-transparent @error('attachments.*') border-red-500 @enderror"
                        >
                        @error('attachments.*')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div class="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                        <div class="flex items-start gap-3">
                            ...
                            <div class="text-sm text-blue-800">
                                <p class="font-semibold mb-1">Response Time</p>
