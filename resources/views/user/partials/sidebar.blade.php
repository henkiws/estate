<div class="flex flex-col h-full">
    ...
    <nav class="flex-1 p-4 space-y-1">
        ...
        <a href="{{ route('user.profile.overview') }}" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group {{ request()->routeIs('user.profile.*') ? 'bg-plyform-purple/10 text-plyform-purple font-semibold border-l-4 border-plyform-purple' : 'text-gray-700 hover:bg-plyform-mint/20 hover:text-plyform-dark' }}">
        ...
        <a href="{{ route('user.applications.index') }}" 
           class="flex items-center gap-3 px-4 py-3 rounded-xl transition-all group {{ request()->routeIs('user.applications.*') ? 'bg-plyform-mint text-plyform-dark font-semibold' : 'text-gray-700 hover:bg-plyform-mint/20 hover:text-plyform-dark' }}">
