...
<div class="mb-8">
    <div class="flex items-center gap-3 mb-4">
        <a href="{{ route('admin.agencies.show', $agency->id) }}" class="p-2 hover:bg-gray-100 rounded-lg transition">
...
<form action="{{ route('admin.agencies.update', $agency->id) }}" method="POST" class="max-w-4xl">
    ...
    <div class="space-y-8">
                ...
                <div class="grid md:grid-cols-2 gap-6">
                    ...
                    <div>
                        <label for="license_holder_name" class="block text-sm font-semibold text-gray-700 mb-2">
                            License Holder Name <span class="text-red-500">*</span>
                        </label>
                        <input type="text" 
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100">
                <h2 class="text-xl font-bold text-gray-900">Agency Status</h2>
            </div>
            <div class="p-6">
                <div>
        ...
        <div class="flex gap-4">
            <button type="submit" class="px-8 py-4 bg-primary text-white rounded-xl font-semibold hover:bg-primary-dark transition flex items-center gap-2">
