...
<div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100">
        <div class="flex items-center justify-between mb-4">
            ...
            <span class="text-xs font-semibold text-blue-600 bg-blue-100 px-2 py-1 rounded-full">Profiles</span>
        </div>
        <div class="text-2xl font-bold text-gray-900 mb-1">{{ $pendingProfilesCount ?? 0 }}</div>
    ...
    <div class="lg:col-span-2 space-y-8">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100">
            <div class="p-6 border-b border-gray-100 flex items-center justify-between">
                <div>
                    <h2 class="text-xl font-bold text-gray-900">User Profiles Needing Review</h2>
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-3 mb-2">
                                <div class="w-10 h-10 bg-blue-100 rounded-full flex items-center justify-center flex-shrink-0">
                                    <span class="text-blue-600 font-bold text-sm">{{ substr($profile->user->name, 0, 1) }}</span>
                                </div>
                                <div>
                                    <h3 class="font-semibold text-gray-900">{{ $profile->first_name }} {{ $profile->last_name }}</h3>
                            ...
                            <div class="grid grid-cols-2 gap-4 text-sm mb-3 ml-13">
                                <div>
                                    ...
                                    <span class="text-gray-900 font-medium ml-2">{{ $profile->date_of_birth ? $profile->date_of_birth->format('M d, Y') : 'N/A' }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500">Mobile:</span>
                                    <span class="text-gray-900 font-medium ml-2">{{ $profile->mobile_country_code }} {{ $profile->mobile_number }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500">Submitted:</span>
                                    <span class="text-gray-900 font-medium ml-2">{{ $profile->submitted_at ? $profile->submitted_at->diffForHumans() : 'N/A' }}</span>
                                </div>
                                <div>
                                    <span class="text-gray-500">ID Points:</span>
                                    <span class="font-medium ml-2 {{ $totalPoints >= 80 ? 'text-green-600' : 'text-red-600' }}">
                                        {{ $totalPoints }} points
                                    </span>
                                </div>
                            </div>
    ...
    <div class="space-y-8">
        ...
        <div class="bg-gradient-to-br from-primary to-primary-dark rounded-2xl p-6 text-white">
            ...
            <div class="space-y-4 mt-6">
                ...
                <div class="h-px bg-white/20"></div>
                <div class="flex justify-between items-center">
                    <span class="text-white/80 text-sm">User Profiles Approved</span>
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
            ...
            <div class="space-y-3">
                ...
                <a href="{{ route('admin.profiles.index', ['status' => 'pending']) }}" 
                   class="w-full flex items-center gap-3 px-4 py-3 bg-blue-100 text-blue-700 rounded-xl hover:bg-blue-600 hover:text-white transition-all font-semibold">
                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z"/>
                    </svg>
