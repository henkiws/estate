<aside id="sidebar" class="fixed left-0 top-0 z-40 h-screen w-64 bg-white border-r border-gray-200 transition-transform duration-300 -translate-x-full lg:translate-x-0">
    <div class="flex flex-col h-full">
        ...
        <nav class="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            <a href="{{ route('agency.agents.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('agency.agents.index') ? 'text-plyform-dark bg-gradient-to-r from-plyform-yellow to-plyform-mint font-semibold' : 'text-gray-700 hover:bg-plyform-mint/10' }} rounded-xl font-medium transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <a href="{{ route('agency.properties.index') }}" class="flex items-center gap-3 px-4 py-3 {{ request()->routeIs('agency.properties.index') ? 'text-plyform-dark bg-gradient-to-r from-plyform-yellow to-plyform-mint font-semibold' : 'text-gray-700 hover:bg-plyform-mint/10' }} rounded-xl font-medium transition-colors">
                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
