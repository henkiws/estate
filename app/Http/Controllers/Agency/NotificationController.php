...
{
    /**
     * Display all notifications for agency
     */
    public function index(Request $request)
    {
        ...
        return view('agency.notifications.index', compact('notifications', 'stats', 'categoryCounts'));
    }
    ...
    public function show(Notification $notification)
    {
        ...
        return view('agency.notifications.show', compact('notification', 'previous', 'next'));
    }
}